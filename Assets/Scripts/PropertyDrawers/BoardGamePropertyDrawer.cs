...
[CustomPropertyDrawer(typeof(BoardGame))]
public class BoardGamePropertyDrawer : PropertyDrawer
{
    #region Field
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        var rows = property.FindPropertyRelative("RowData");
        ...
        for (int i = 0; i < rowsValue.intValue; i++)
        {
            ...
            var columns = rows.GetArrayElementAtIndex(i).FindPropertyRelative("CellData");
